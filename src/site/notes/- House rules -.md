...
Do spend time choosing background and feats, and use these to think about the characters background. I like allowing for an extra feat at level 1 (see below) but only if the player can describe how they learned this, and from whom.
